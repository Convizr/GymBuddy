...
export const TimePickerExtension = {
    ...
    render: ({ trace, element }) => {
        ...
        // Handle edge case where the split results in array with improper values
        if (!availableTimes || availableTimes.length === 0 || availableTimes[0] === "") {
            console.error('No available times provided or incorrect format:', availableTimes);
